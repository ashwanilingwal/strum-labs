...
player, and the legal fine print. The practice screen has three modes — drill a
chord, play a progression, or the exercise curriculum: fourteen graded
listening games, from naming the open strings through hammer-ons and pull-offs
to four-finger spider drills and picking rolls. Every exercise is the same
game: the app names a note, you find it at your own pace, the microphone
confirms and deals the next. The hub (`/learn`) holds the chord library (tap
any card to hear it) and your saved patterns (filterable, with one-tap
previews).
